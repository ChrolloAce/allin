...
const serviceFAQs: Record<string, ServiceFAQ[]> = {
  '24-7-emergency': [
    ...
    {
      question: 'How quickly can you respond to emergency calls in The Palm Beaches?',
      answer: 'We guarantee response within 60 minutes for emergency calls in The Palm Beaches and surrounding areas. Our emergency plumbers are stationed throughout the Palm Beach County area for rapid response 24/7.'
    },
    {
  ...
  'iron-removal': [
    {
      ...
      answer: 'Common signs include orange/brown staining on fixtures, metallic taste, discolored laundry, and reddish-brown particles in water. We offer free water testing to determine exact iron levels in your Palm Beaches home.'
    },
    {
  ...
  'water-heaters': [
    {
      question: 'How long do water heaters typically last in The Palm Beaches?',
      answer: 'Tank water heaters last 8-12 years, while tankless units can last 20+ years with proper maintenance. The Palm Beaches\' hard water can reduce lifespan, making annual flushing essential.'
    },
    {
  ...
  'bathroom-plumbing': [
    ...
    {
      question: 'How much does it cost to replace a toilet in The Palm Beaches?',
    ...
    },
    {
      ...
      answer: 'Yes! Tub-to-shower conversions are popular in The Palm Beaches. We handle all plumbing modifications, ensuring proper drainage and waterproofing.'
    }
  ],
  'leak-detection': [
    {
    ...
    {
      question: 'Do you detect slab leaks in Palm Beaches homes?',
      answer: 'Yes! Slab leaks are common in The Palm Beaches. We specialize in under-slab leak detection and offer both traditional repair and epoxy pipe lining solutions.'
    },
    {
  ...
  'gas-lines': [
    {
      question: 'Are you licensed for gas line work in The Palm Beaches?',
  ...
  'commercial-residential': [
    ...
    },
    {
      ...
      answer: 'Yes! We work with many HOAs and condo associations in The Palm Beaches, handling both common area plumbing and coordination of unit repairs.'
    }
  ],
  'lead-detection': [
    {
    ...
    {
      question: 'Does The Palm Beaches have lead pipe issues?',
      answer: 'While less common than northern cities, some older Palm Beaches neighborhoods have lead service lines. We help identify and replace these pipes.'
    }
  ],
  'backflow-prevention': [
    {
    ...
    {
      question: 'Is backflow testing required in The Palm Beaches?',
  ...
  'annual-flush': [
    {
      ...
      answer: 'Flushing removes sediment buildup that reduces efficiency, causes noise, and shortens heater life. In The Palm Beaches\' hard water, annual flushing is essential.'
    },
    {
  ...
  'water-quality': [
    {
      question: 'What water quality issues are common in The Palm Beaches?',
      answer: 'Palm Beaches water often has high chlorine, hardness, and occasionally taste/odor issues. We test for all parameters and recommend appropriate treatment solutions.'
    },
    {
  ...
  return serviceFAQs[serviceSlug] || [
    {
      ...
      answer: 'We offer same-day and next-day service for most non-emergency calls in The Palm Beaches. Emergency services are available 24/7 with response times under 60 minutes.'
    },
    {
